...
parser.add_argument('--src_exp_dir', type=str, default=r'100dB-10T-0.5port-2000Itr-N8',
                    help='source experimental directory')
parser.add_argument('--NN', type=str, default=r'Atten',
                    help='Atten,LSTM')
parser.add_argument('--exp_name', type=str, default='100dB-10T-0.5port-2000Itr-N8-softQuantize',
...
parser.add_argument('--quantize',  type=str,default='opt',help='none,uniform,opt')
...
if __name__ == '__main__':
    ...
    model = CSIModel(input_size=64, hidden_size=512, Na=32, T=args.T, Np=32, n_layer=1, fixM=args.fixM, seed=args.seed,
                     model=args.NN, datapath=data_filepath, Q_mod=args.Q_mod, nB=nB).cuda()
