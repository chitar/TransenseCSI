...
if __name__ == '__main__':
    ...
    model = CSIModel(input_size=64, hidden_size=512, Na=32, T=args.T, Np=32,n_layer=1, fixM=args.fixM, seed=args.seed, model=args.NN,datapath=data_filepath,Q_mod=args.Q_mod,nB=nB).cuda()
