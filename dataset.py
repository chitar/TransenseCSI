...
class CSIDataset(Dataset):
    ...
    def __init__(self, filepath, train, train_portion,seed=2,SNR_dB=None,noise='None',nB=16):
        ...
        self.csi = torch.from_numpy(np.array(data['M_DCSnn_csi'])).type(torch.cfloat)#.permute(1,0)
        ...
        # io.savemat('data_and_indices.mat',{'CSI':data['M_DCSnn_csi'],'codebook':data['T1_CB_woP'],'test_indices':indices[sep:]})
